          ...
          <div class="space-y-8">
            ...
            <div class="p-6 bg-white/70 backdrop-blur-sm rounded-xl border border-green-200/30 shadow-md">
              ...
              <ul class="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>Không được can thiệp vào hoạt động bình thường của website</li>
            ...
            <div class="p-6 bg-white/70 backdrop-blur-sm rounded-xl border border-green-200/30 shadow-md">
              ...
              <ul class="list-disc list-inside space-y-2 text-gray-700">
                <li>Thông tin sản phẩm được cập nhật thường xuyên</li>
            ...
            <div class="p-6 bg-white/70 backdrop-blur-sm rounded-xl border border-green-200/30 shadow-md">
              ...
              <ul class="list-disc list-inside space-y-2 text-gray-700">
                ...
                <li>Thông tin cá nhân được bảo mật theo chính sách riêng tư</li>
